...
use super::dynamicefi::{DynamicEfiChannel, DynamicEfiMeta};
...
impl Serialize for Channel {
        ...
        S: serde::Serializer,
    {
        match self {
            ...
            Channel::DynamicEfi(d) => d.serialize(serializer),
...
impl Channel {
    pub fn name(&self) -> String {
        match self {
            ...
            Channel::DynamicEfi(d) => d.name.clone(),
    ...
    pub fn type_name(&self) -> String {
        match self {
            ...
            Channel::DynamicEfi(_) => "DynamicEFI".to_string(),
